...
<head>
    ...
    <title><?= esc($title ?? '500 — Server Error') ?> — ERP Textile</title>
            ...
            <div class="row min-vh-100 flex-center text-center">
                <div class="col-12 col-xl-10">
                    ...
                    <div class="d-flex flex-center mb-4">
                        <h1 class="display-1 fw-bold text-danger" style="font-size: 8rem; line-height: 1;">
                            500
                        </h1>
                    </div>

                    <h2 class="text-body-emphasis fw-bold mb-2">Terjadi Kesalahan Server</h2>
                    <p class="text-body-tertiary mb-5">
                        <?= esc($message ?? 'Terjadi kesalahan pada server. Silakan coba beberapa saat lagi atau hubungi administrator.') ?>
                    </p>
                    ...
                    <div class="d-flex flex-center flex-wrap gap-3">
                        ...
                        <a href="javascript:location.reload()" class="btn btn-phoenix-secondary px-5">
