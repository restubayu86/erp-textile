    ...
    e =
      (b.extend(a.prototype, {
          ...
          var o = this,
            ...
            e =
              ...
              this.c.breakpoints.sort(function (e, t) {
                return e.width < t.width ? 1 : t.width < e.width ? -1 : 0;
              }),
              this._classLogic(),
              this.c.details);
          !1 !== e.type &&
            ...
            r
              .on("draw.dtr", function () {
                r.page.info().serverSide && (o.s.childNodeStore = {}),
                  o._controlClass();
              })
              .ready(function () {
                o._resizeAuto(),
          ...
          var n = this,
            ...
            r =
              ...
              b(i.table().body()).on("keyup.dtr", "td, th", function (e) {
                var t = d.activeElement.nodeName.toLowerCase();
                13 !== e.keyCode ||
            ...
            if (!e.never && !e.control)
              return (
                ...
                o[t] || (o[t] = r.column(t)),
                {
                  className: e.sClass,
                  columnIndex: t,
                  data: s.fastData(n, t, i.c.orthogonal),
                  hidden: o[t].visible() && !i.s.current[t],
                  rowIndex: n,
                  title: o[t].title(),
                }
              );
        ...
        _resize: function (n) {
          ...
          var c = this._columnsVisibility(s),
        ...
        details: {
          ...
          renderer: (a.renderer = {
            listHiddenNodes: function () {
              function e(n, e, t) {
                var i = this,
                  r = b('<ul data-dtr-index="' + e + '" class="dtr-details"/>'),
                  o = !1;
                return (
                      ...
                      (b(
                        ...
                        .append(
                          b('<span class="dtr-data"/>').append(
                            i._childNodes(n, t.rowIndex, t.columnIndex)
                          )
                        )
                        .appendTo(r),
                      (o = !0));
