(function (global, factory) {
  ...
  const configQueryMap = {
    ...
    initialConfig = {
      ...
      phoenixNavbarTopShape: "navbar-slim",
      phoenixIsRTL: !1,
  ...
  Object.keys(params).length > 0 &&
    ...
    "dark" === localStorage.getItem("phoenixTheme")
      ...
      : "auto" === localStorage.getItem("phoenixTheme") &&
    ...
    "horizontal" === localStorage.getItem("phoenixNavbarPosition") &&
      document.documentElement.setAttribute(
        "data-navigation-type",
        "horizontal"
      ),
    "combo" === localStorage.getItem("phoenixNavbarPosition") &&
