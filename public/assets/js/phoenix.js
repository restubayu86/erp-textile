(function (global, factory) {
  ...
  class BulkSelect {
    ...
    toggleDisplay(e, t) {
      (e || t) &&
        (e.classList.toggle(this.option.displayNoneClassName),
        t.classList.toggle(this.option.displayNoneClassName)),
          ...
          document.querySelectorAll(".needs-validation").forEach((e) => {
            const i = () => {
              e.querySelectorAll(".choices").forEach((e) => {
                const i = e.querySelector(".choices__list--single"),
                  s = e.querySelector(".choices__list--multiple");
                if (
                  ...
                  const { selectedOptions: i } = t;
                  i.length > 0 && [...i].some((e) => "" !== e.value)
  ...
  const featherIconsInit = () => {
    window.feather &&
      ...
      document.documentElement.classList.add("feather-icons-ready"));
  };
  ...
  const flatpickrInit = () => {
    ...
    document.querySelectorAll(".datetimepicker").forEach((t) => {
      ...
      window.flatpickr(t, {
        ...
        onDayCreate: (e, t, o, s) => {
          (6 !== s.dateObj.getDay() && 0 !== s.dateObj.getDay()) ||
            (s.className += " weekend-days");
        },
        ...o,
      });
    });
            ...
            return (
              document.querySelector(a)?.addEventListener("click", (e) => {
                ...
                i &&
                  document
                    .querySelectorAll(
                      'span[class*="gallery-column-separator-"]'
                    )
                    .forEach((e) => e.remove()),
                  setTimeout(() => {
    ...
    if (o) {
      ...
      o.forEach((o) => {
        ...
        if (window._.merge({ autoShow: !1 }, d).autoShow) {
          ...
          o.querySelector("[data-disable-modal-auto-show]").addEventListener(
            "click",
            () => {
      ...
      window.addEventListener("resize", () => {
        a.forEach((o) => {
          const t = new window.bootstrap.Offcanvas(o),
            ...
            a = e[n];
          window.innerWidth >= a &&
            ((document.body.style.overflow = ""), t.hide());
        });
      });
    }
    const d = (e) => {
    ...
    const { resize: e } = window.phoenix.utils,
      ...
      a = () => {
        const e = n.clientWidth,
          ...
          c = n.querySelector(i)?.clientWidth || 0;
        let d = 0;
        (l.style.display = "none"),
          r.forEach((e) => {
            ...
            if (
              ...
              d + (c || 0) + o > a && !e.classList.contains("dropdown"))
            ) {
              (l.style.display = "block"), (e.style.display = "none");
              const t = e.firstChild.cloneNode(!0);
              n.querySelector(".category-list").appendChild(t);
            }
          });
        n.querySelectorAll(".dropdown-menu .nav-link").forEach((e) => {
        ...
        if (d.data("theme-control")) {
          ...
          switch (
            ...
            case "phoenixNavbarTopStyle":
              c.setAttribute("data-navbar-appearance", "default"),
                "default" !== h &&
                  c.setAttribute("data-navbar-appearance", "darker");
              break;
        ...
        e.addEventListener(
          ...
          (t) => (
            ...
            (m &&
              v &&
              (m.value !== v.value
                ? v.setCustomValidity("Invalid field.")
                : v.setCustomValidity("")),
            !e.checkValidity())
              ? (q.preventDefault(), !1)
              : ((E += 1), null)
          ...
          b.forEach((t, a) => {
            t.addEventListener(c, (a) => {
              ...
              t.addEventListener(u, () => {
                ...
                for (let e = 0; e < E; e += 1)
                  b[e].classList.add("done"),
                    e > 0 && b[e - 1].classList.add("complete");
                for (let e = E; e < b.length; e += 1)
                  b[e].classList.remove("done"),
                    e > 0 && b[e - 1].classList.remove("complete");
                E > b.length - 2
      ...
      o &&
        o.forEach((o) => {
          ...
          if (n) {
            ...
            o.center &&
              new window.mapboxgl.Marker({ color: getColor("danger") })
                .setLngLat(o.center)
                .addTo(m),
              r &&
                a &&
                (r.addEventListener("click", () => m.zoomIn()),
                a.addEventListener("click", () => m.zoomOut())),
              l &&
                l.addEventListener("click", () =>
      ...
      e.forEach((e) => {
        ...
        t.addEventListener("change", (t) => {
          (r[0].checked = !0),
            t.target.checked
              ? e.classList.add("active")
              : (e.classList.remove("active"), c.hide());
        }),
          r.forEach((e) => {
      ...
      document.addEventListener("click", (e) => {
        if (e.target.closest("[data-video-controller]")) {
          const a = e.target.closest("[data-video-controller]"),
            l = a
              .closest("[data-play-on-container-hover]")
              .querySelector("[data-play-on-hover]"),
  ...
  const passwordToggleInit = () => {
    ...
    t &&
      t.forEach((t) => {
        ...
        e.addEventListener("click", () => {
          "password" === s.type
            ? (s.setAttribute("type", "text"), e.classList.add("show-password"))
    ...
    const e = "change",
      ...
      L = (e) => {
        Array.from(e.querySelectorAll(s))
          ...
          .forEach((e, t) => {
            t % 2 == 0
              ? (e.classList.add(u), e.classList.remove(f))
              : (e.classList.add(f), e.classList.remove(u));
          });
      };
    E.length &&
      E.forEach((s) => {
          ...
          E.forEach((o) => {
            ...
            if (
              ...
              o.addEventListener(r, (e) => {
                if (
                  (e.target.classList.add(m), e.target.classList.remove(v), f)
                )
                  L(s);
                else {
                  const t = e.composedPath()[2].querySelectorAll(c);
                  e.composedPath()[2].classList.contains(n) ||
                    0 !== t.length ||
                    e.composedPath()[2].classList.remove(p);
                }
              }),
              "true" === o.dataset.show)
            ) {
              const e = [o];
              for (; o.parentElement; )
                o.parentElement.classList.contains(d) &&
                  e.unshift(o.parentElement),
                  (o = o.parentElement);
              e.forEach((e) => {
            ...
            if (u) {
              s.querySelector(`input[data-target='#${a}']`).addEventListener(
                e,
                (e) => {
                  Array.from(
                    s.querySelector(`#${a}`).querySelectorAll(l)
                  ).forEach((t) => {
